...
public class AddressServiec extends Service {
		...
		public void onCallStateChanged(int state, String incomingNumber) {
			...
			switch(state){
			    ...
			    case TelephonyManager.CALL_STATE_RINGING:       //电话响铃状态
			    	LogManagement.i(TAG, "来电号码是:" + incomingNumber);
	...
	public void showLocation(String address) {
		...
		if(background == 0){
			ll.setBackgroundResource(R.drawable.call_locate_gray); //设置背景
		...
		tv.setTextSize(this.getResources().getDimension(R.dimen.atool_textsize_noservice));//设置字体大小
		tv.setText(address);
