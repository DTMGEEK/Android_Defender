...
public class AppInfoProvider {
	...
	public List<AppInfo> getAllApp(){
		...
		List<AppInfo> appInfos = new ArrayList<AppInfo>();  //保存appinfo信息
		List<PackageInfo> packInfos = this.manager.getInstalledPackages(PackageManager.GET_UNINSTALLED_PACKAGES); //获取所有安装了的软件信息
		for(PackageInfo info:packInfos){
			...
			appinfo.setAppname(applicationinfo.loadLabel(manager).toString());  //设置名称
